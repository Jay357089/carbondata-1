...
class ExternalColumnDictionaryTestCase extends QueryTest with BeforeAndAfterAll {
  ...
  def buildRelation() = {
    ...
    verticalDelimiteRelation = catalog.lookupRelation1(None, "verticalDelimitedTable", None)(CarbonHiveContext)
      .asInstanceOf[CarbonRelation]
    loadSqlRelation = catalog.lookupRelation1(None, "loadSqlTest", None)(CarbonHiveContext)
      .asInstanceOf[CarbonRelation]
  }
